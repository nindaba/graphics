...
patch
    .description("News component (Spartacus UI)")
    .withImpexes()
    .syncContentCatalogs(ContentCatalogEnum.KC_PORTAL)
    .i18nMessages(
        i18n("homepage.news.heading", STOREFRONT)
            .message(EN, "Latest news"),
        i18n("homepage.news.viewAll", STOREFRONT)
            .message(EN, "View all news"),
        i18n("homepage.news.item.important", STOREFRONT)
            .message(EN, "Important")
    )
