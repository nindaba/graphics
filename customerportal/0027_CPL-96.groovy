...
patch
    ...
    .i18nMessages(
        i18n("search.products.all", STOREFRONT)
            .message(EN, "Products"),
        i18n("search.products.searchText", STOREFRONT)
            .message(EN, "You searched for <i>{{freeTextSearch}}</i>"),
        i18n("search.products.totalResults", STOREFRONT)
            .message(EN, "{{totalResults}} products found"),
    )
