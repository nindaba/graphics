...
patch.description("Asset fleet page")
    .syncContentCatalogs(ContentCatalogEnum.KC_PORTAL)
    .withImpexes()
    .i18nMessages(
        i18n("asset.fleet.heading", STOREFRONT)
            .message(EN, "Asset fleet"),
        i18n("asset.fleet.card.customer.asset.name.missing", STOREFRONT)
            .message(EN, "Untitled asset"),
        i18n("asset.fleet.card.customer.manufacturer.name.missing", STOREFRONT)
            .message(EN, "undefined"),
        i18n("asset.fleet.card.customer.location.missing", STOREFRONT)
            .message(EN, "undefined"),
        i18n("asset.fleet.card.customer.criticality.na", STOREFRONT)
            .message(EN, "N/A"),
    )
