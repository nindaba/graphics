...
patch
    .description("Order component - filtering")
    .i18nMessages(
        i18n("orderHistory.filter.all", STOREFRONT)
            .message(EN, "ALL"),
        i18n("orderHistory.filter.open", STOREFRONT)
            .message(EN, "OPEN"),
        i18n("orderHistory.filter.requiresAction", STOREFRONT)
            .message(EN, "REQUIRES ACTION"),
        i18n("orderHistory.filter.inProgress", STOREFRONT)
            .message(EN, "IN PROGRESS"),
        i18n("orderHistory.filter.shipped", STOREFRONT)
            .message(EN, "SHIPPED")
    )
